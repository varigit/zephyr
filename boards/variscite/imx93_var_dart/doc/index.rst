...
The Zephyr imx93_var_dart board Cortex-A Core configuration supports the following
hardware features:
...
The Zephyr imx93_var_dart board Cortex-M33 configuration supports the following
hardware features:
