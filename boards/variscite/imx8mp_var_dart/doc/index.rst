...
The Zephyr imx8mp_var_dart board for Cortex-A53 configuration support the following hardware
features:
...
The Zephyr imx8mp_var_dart board for Cortex-M7 configuration support the following hardware
features:
...
:zephyr_file:`boards/variscite/imx8mp_var_dart/imx8mp_var_dart_mimx8ml8_m7_defconfig`

It is necessary to disable peripherals used by the M7 core on the Linux host.
...
This will build an image with the hello_world sample app, boot it and display the
following ram console output:
...
.. code-block:: console
   ...
   load mmc 1:1 0x7e000000 /boot/zephyr.bin
   dcache flush
   bootaux 0x7e000000
